# 1 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_DA_HOD/src/USS_DA_HOD.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 10 "<built-in>"
...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_DA_HOD/src/USS_DA_HOD.c" 2
/**************************************************************************************************\
 *** 
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 96 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_DA_HOD/src/USS_DA_HOD.c" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 97 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_DA_HOD/src/USS_DA_HOD.c" 2
...
uint16 USS_HOD_s_LatHodNoCntctTi_s_measure = 0; /* 
    ...
    LSB: 2^0 OFF: 0 MIN/MAX: 0 .. 65535
    Description: time since last contact at the steering wheel */
# 132 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_DA_HOD/src/USS_DA_HOD.c"
/**************************************************************************************************\
    GLOBAL_A2L_MODULE_OUT: mergeable global variables (RAM)
(entspricht MERGEABLE_GLOBAL) | Width: 8
\**************************************************************************************************/
uint8 USS_HOD_s_LatHodIntrp_measure = 0; /* 
    ...
    LSB: 2^0 OFF: 0 MIN/MAX: 0 .. 255
    Description: Current interpretation of the steering wheel contact */
# 149 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_DA_HOD/src/USS_DA_HOD.c"
/**************************************************************************************************\
...
# 163 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_DA_HOD/src/USS_DA_HOD.c"
/**************************************************************************************************\
    SLStaticGlobalInit: Default storage class for global static variables with initial value | Width
    : 16
\**************************************************************************************************/
static uint16 X_SUSS_DA_HOD12_Delay;
# 177 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_DA_HOD/src/USS_DA_HOD.c"
/**************************************************************************************************\
    MEASUREMENT: global observable variables (RAM) -- used by Utilities_lib/Measurement | Width: 8
\**************************************************************************************************/
