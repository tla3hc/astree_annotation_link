# 1 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_DS_DSF/src/USS_DS_DSF.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 10 "<built-in>"
...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_DS_DSF/src/USS_DS_DSF.c" 2
/**************************************************************************************************\
 *** 
 ...
 ***
 *** Generation date: 2024-08-22 19:33:57
 ***
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 210 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_DS_DSF/src/USS_DS_DSF.c" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_DS_DSF/src/USS_DS_DSF.h" 1
/**************************************************************************************************\
 *** 
 *** Simulink model       : USS_DS_DSF
 *** TargetLink subsystem : USS_DS_DSF/FrameDSF/Subsystem/FrameDSF/DrivingStyleFusionDS_DSF
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 211 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_DS_DSF/src/USS_DS_DSF.c" 2
...
# 248 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_DS_DSF/src/USS_DS_DSF.c"
/**************************************************************************************************\
    GLOBAL_A2L_MODULE_OUT: mergeable global variables (RAM)
(entspricht MERGEABLE_GLOBAL) | Width: 8
\**************************************************************************************************/
...
uint8 USS_DSF_s_StDrvTyp_measure = 0; /* 
    ...
    LSB: 2^0 OFF: 0 MIN/MAX: 0 .. 255
    Description: status driver type */
# 269 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_DS_DSF/src/USS_DS_DSF.c"
/**************************************************************************************************\
    SLStaticGlobalInit: Default storage class for global static variables with initial value | Width
    : 8
\**************************************************************************************************/
static boolean SUSS_DS_DSF1_DrivingStyleFusionDS_DSF_FirstRun = 1;
# 283 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_DS_DSF/src/USS_DS_DSF.c"
/**************************************************************************************************\
    MEASUREMENT: global observable variables (RAM) -- used by Utilities_lib/Measurement | Width: 32
\**************************************************************************************************/
...
# 298 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_DS_DSF/src/USS_DS_DSF.c"
/**************************************************************************************************\
    MEASUREMENT: global observable variables (RAM) -- used by Utilities_lib/Measurement | Width: 8
\**************************************************************************************************/
uint8 USS_DSF_s_MinIdx_measure; /* LSB: 2^0 OFF: 0 MIN/MAX: 0 .. 4 */
# 311 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_DS_DSF/src/USS_DS_DSF.c"
/**************************************************************************************************\
    MEASUREMENT: global observable variables (RAM) -- used by Utilities_lib/Measurement | Width: 8
\**************************************************************************************************/
