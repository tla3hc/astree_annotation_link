# 1 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/30_T/40_SCA/stubs/USS_ID_PRP_stub.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 10 "<built-in>"
...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/30_T/40_SCA/stubs/USS_ID_PRP_stub.c" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 2 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/30_T/40_SCA/stubs/USS_ID_PRP_stub.c" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 3 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/30_T/40_SCA/stubs/USS_ID_PRP_stub.c" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/30_T/40_SCA/rte\\USSDB_MemMap.h" 1
# 4 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/30_T/40_SCA/stubs/USS_ID_PRP_stub.c" 2
void USS_ID_PRP_stub(uint8 USS_GC_s_BrkFrq, uint8 USS_GC_s_StgFrq, uint16
  USS_SIH_s_RGTrfcLghtDst_dm, uint8 USS_SIH_s_RGTrfcMovmtPhaSt, boolean * USS_IPR_s_AcclOvtkReq,
  boolean * USS_IPR_s_LeadVehBrk, boolean * USS_IPR_s_SddnAccl, boolean * USS_IPR_s_SddnBrkSig,
  boolean * USS_IPR_s_SddnStg, boolean * USS_IPR_s_StartTrgGreenTrffcLght, boolean *
  USS_IPR_s_StartTrgRedTrffcLght, boolean * USS_IPR_s_StartTrgSdnLeadVeh, boolean *
  ...
  USS_IPR_s_StopTrgSdnLeadVeh, boolean * USS_IPR_s_VehStopSig, boolean * USS_IPR_s_VehStrtSig)
{
 __ASTREE_check(( USS_GC_s_BrkFrq >= 0 && USS_GC_s_BrkFrq <= 255 ));
 __ASTREE_check(( USS_GC_s_StgFrq >= 0 && USS_GC_s_StgFrq <= 255 ));
 __ASTREE_check(( USS_SIH_s_RGTrfcLghtDst_dm >= 0 && USS_SIH_s_RGTrfcLghtDst_dm <= 40000 ));
 __ASTREE_check(( USS_SIH_s_RGTrfcMovmtPhaSt >= 0 && USS_SIH_s_RGTrfcMovmtPhaSt <= 10 ));
 __ASTREE_modify(( *USS_IPR_s_AcclOvtkReq; [0 ,1] ));
 __ASTREE_modify(( *USS_IPR_s_LeadVehBrk; [0 ,1] ));
 __ASTREE_modify(( *USS_IPR_s_SddnAccl; [0 ,1] ));
 __ASTREE_modify(( *USS_IPR_s_SddnBrkSig; [0 ,1] ));
 __ASTREE_modify(( *USS_IPR_s_SddnStg; [0 ,1] ));
 __ASTREE_modify(( *USS_IPR_s_StartTrgGreenTrffcLght; [0 ,1] ));
 __ASTREE_modify(( *USS_IPR_s_StartTrgRedTrffcLght; [0 ,1] ));
 __ASTREE_modify(( *USS_IPR_s_StartTrgSdnLeadVeh; [0 ,1] ));
 __ASTREE_modify(( *USS_IPR_s_StopTrgGreenTrffcLght; [0 ,1] ));
 __ASTREE_modify(( *USS_IPR_s_StopTrgRedTrffcLght; [0 ,1] ));
 __ASTREE_modify(( *USS_IPR_s_StopTrgSdnLeadVeh; [0 ,1] ));
 __ASTREE_modify(( *USS_IPR_s_VehStopSig; [0 ,1] ));
 __ASTREE_modify(( *USS_IPR_s_VehStrtSig; [0 ,1] ));
