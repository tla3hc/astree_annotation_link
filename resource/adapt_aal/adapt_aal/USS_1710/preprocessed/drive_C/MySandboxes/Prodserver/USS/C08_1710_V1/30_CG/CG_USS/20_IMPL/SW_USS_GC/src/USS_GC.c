# 1 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_GC/src/USS_GC.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 10 "<built-in>"
...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_GC/src/USS_GC.c" 2
/**************************************************************************************************\
 *** 
 ...
 *** Codefile             : USS_GC.c
 ***
 *** Generation date: 2024-08-23 06:39:52
 ***
...
/* RULECHECKER_suppress(rules-category) */
__ASTREE_attributes((coverage_ignore, raise_at_caller, hide_directives));
# 288 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_GC/src/USS_GC.c" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 289 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_GC/src/USS_GC.c" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_GC/src/USS_GC.h" 1
/**************************************************************************************************\
 *** 
 *** Simulink model       : USS_GC
 *** TargetLink subsystem : USS_GC/FrameGC/Subsystem/FrameGC/GeneralCalculationGC
...
# 1 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_GC/src/tl_defines_USS_GC.h" 1
/**************************************************************************************************\
 *** 
 *** Simulink model       : USS_GC
 *** TargetLink subsystem : USS_GC/FrameGC/Subsystem/FrameGC/GeneralCalculationGC
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 65 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_GC/src/USS_GC.h" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_GC/src/UTILS_lib_UssFrqCtrR.h" 1
/**************************************************************************************************\
 *** 
 *** Simulink model       : USS_GC
 *** TargetLink subsystem : USS_GC/FrameGC/Subsystem/FrameGC/GeneralCalculationGC
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 66 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_GC/src/USS_GC.h" 2
...
\**************************************************************************************************/
extern void USS_GC(uint8 * USS_GC_s_StgFrq, uint8 * USS_GC_s_BrkFrq);


/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 290 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_GC/src/USS_GC.c" 2
...
# 322 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_GC/src/USS_GC.c"
/**************************************************************************************************\
...
# 349 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_GC/src/USS_GC.c"
/**************************************************************************************************\
    GLOBAL_A2L_MODULE_OUT: mergeable global variables (RAM)
(entspricht MERGEABLE_GLOBAL) | Width: 32
\**************************************************************************************************/
...
# 396 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_GC/src/USS_GC.c"
/**************************************************************************************************\
    GLOBAL_A2L_MODULE_OUT: mergeable global variables (RAM)
(entspricht MERGEABLE_GLOBAL) | Width: 8
\**************************************************************************************************/
...
boolean USS_GC_s_VNotSdsl_measure = 0; /* 
    ...
    LSB: 2^0 OFF: 0 MIN/MAX: 0 .. 1
    Description: 0: standsill  1: standstill */
# 445 "C:/MySandboxes/Prodserver/USS/C08_1710_V1/30_CG/CG_USS/20_IMPL/SW_USS_GC/src/USS_GC.c"
/**************************************************************************************************\
    MEASUREMENT: global observable variables (RAM) -- used by Utilities_lib/Measurement | Width: 32
\**************************************************************************************************/
 ...
 ***
\**************************************************************************************************/
                       void USS_GC(uint8 * USS_GC_s_StgFrq, uint8 * USS_GC_s_BrkFrq)
{
    ...
    USS_FrequencyCounter_RF_step(USS_SIH_s_DBRIdcDrvBrk_measure == 2, USS_GC_p_CtDwnStep_s,
     USS_GC_p_OfsDly_s, USS_GC_s_BrkFrq, &tagISV_SUssFrqCtrR1_FrequencyCounterWithCountdown);
    ...
    USS_FrequencyCounter_RF_step(fabsf(USS_GC_s_AgStg_deg_measure) > USS_GC_p_ThStgAg_deg,
     USS_GC_p_CtDwnStep_s, USS_GC_p_OfsDly_s, USS_GC_s_StgFrq,
