# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DA_LAD_stub.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 10 "<built-in>"
...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DA_LAD_stub.c" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 2 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DA_LAD_stub.c" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 3 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DA_LAD_stub.c" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/rte\\USSDB_MemMap.h" 1
# 4 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DA_LAD_stub.c" 2
void USS_DA_LAD_stub(void)
{
 __ASTREE_check(( USS_GC_s_EPSStgTqFil_Nm_measure >= -20.F && USS_GC_s_EPSStgTqFil_Nm_measure <= 20.950000762939453125F ));
 __ASTREE_check(( USS_GC_s_VDSOVLgt_kmph_measure >= -460.100006103515625F && USS_GC_s_VDSOVLgt_kmph_measure <= 460.100006103515625F ));
 __ASTREE_check(( USS_PRP_s_AsiSysLatActFac_measure >= 0.F && USS_PRP_s_AsiSysLatActFac_measure <= 1.F ));
 __ASTREE_check(( USS_SIH_s_EPSCtlValQFK_measure >= -100 && USS_SIH_s_EPSCtlValQFK_measure <= 100 ));
 __ASTREE_check(( USS_SIH_s_VMMLatGuideStReq_measure >= 0 && USS_SIH_s_VMMLatGuideStReq_measure <= 8 ));
 __ASTREE_modify(( USS_LAD_s_CntrStgDet_measure; [0 ,7] ));
 __ASTREE_modify(( USS_LAD_s_LatInAcvTi_s_measure; [0 ,508] ));
 __ASTREE_modify(( USS_LAD_s_LatStgAcv_measure; [0 ,7] ));
}
