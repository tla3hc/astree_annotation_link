# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DA_HOD/src/USS_DA_HOD.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 10 "<built-in>"
...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DA_HOD/src/USS_DA_HOD.c" 2
/**************************************************************************************************\
 *** 
 *** Simulink model       : USS_DA_HOD
 *** TargetLink subsystem : USS_DA_HOD/FrameUSS_DA_HOD/Subsystem/FrameUSS_DA_HOD/DriverActivityDA_HO
 D
 *** Codefile             : USS_DA_HOD.c
 ***
 *** Generation date: 2024-12-05 04:16:54
 ***
 ...
 *** SUSS_DA_HOD1   DriverActivityDA_HOD
 *** SUSS_DA_HOD2   DriverActivityDA_HOD/CalcInActTi
 *** SUSS_DA_HOD3   DriverActivityDA_HOD/CalculationHodIntrp
 *** SUSS_DA_HOD4   DriverActivityDA_HOD/IntervalDynamic
 *** SUSS_DA_HOD5   DriverActivityDA_HOD/MultiMeasure
 *** SUSS_DA_HOD6   DriverActivityDA_HOD/MultiMeasure1
 *** SUSS_DA_HOD7   DriverActivityDA_HOD/MultiMeasure3
 *** SUSS_DA_HOD8   DriverActivityDA_HOD/ReqBlock
 *** SUSS_DA_HOD9   DriverActivityDA_HOD/ReqBlock1
 *** SUSS_DA_HOD10  DriverActivityDA_HOD/ReqBlock2
 *** SUSS_DA_HOD11  DriverActivityDA_HOD/ReqBlock3
 *** SUSS_DA_HOD12  DriverActivityDA_HOD/CalcInActTi/CountUp
 *** SUSS_DA_HOD13  DriverActivityDA_HOD/CalcInActTi/Time2Steps1
 *** SUSS_DA_HOD14  DriverActivityDA_HOD/CalcInActTi/CountUp/CountUp
 *** SUSS_DA_HOD15  DriverActivityDA_HOD/CalcInActTi/CountUp/CountUp/DocBlock
 *** SUSS_DA_HOD16  DriverActivityDA_HOD/CalcInActTi/CountUp/CountUp/DocBlock/EmptySubsystem
 *** SUSS_DA_HOD17  DriverActivityDA_HOD/IntervalDynamic/IntervalDynamic
 *** SUSS_DA_HOD18  DriverActivityDA_HOD/IntervalDynamic/IntervalDynamic/DocBlock
 *** SUSS_DA_HOD19  DriverActivityDA_HOD/IntervalDynamic/IntervalDynamic/DocBlock/EmptySubsystem
 *** SUSS_DA_HOD20  DriverActivityDA_HOD/MultiMeasure/MeasSubsys
 *** SUSS_DA_HOD21  DriverActivityDA_HOD/MultiMeasure/MeasSubsys/ToWorkspaceMeasurement
 *** SUSS_DA_HOD22  DriverActivityDA_HOD/MultiMeasure1/MeasSubsys
 *** SUSS_DA_HOD23  DriverActivityDA_HOD/MultiMeasure1/MeasSubsys/ToWorkspaceMeasurement
 *** SUSS_DA_HOD24  DriverActivityDA_HOD/MultiMeasure3/MeasSubsys
 *** SUSS_DA_HOD25  DriverActivityDA_HOD/MultiMeasure3/MeasSubsys/ToWorkspaceMeasurement
 *** 
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 96 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DA_HOD/src/USS_DA_HOD.c" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DA_HOD/src/USS_DA_HOD.h" 1
/**************************************************************************************************\
 *** 
 *** Simulink model       : USS_DA_HOD
 *** TargetLink subsystem : USS_DA_HOD/FrameUSS_DA_HOD/Subsystem/FrameUSS_DA_HOD/DriverActivityDA_HO
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 97 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DA_HOD/src/USS_DA_HOD.c" 2
...
(entspricht MERGEABLE_GLOBAL) | Width: 16
\**************************************************************************************************/
uint16 USS_HOD_s_LatHodNoCntctTi_s_measure = 0; /* 
    Unit: s
    LSB: 2^0 OFF: 0 MIN/MAX: 0 .. 65535
    Description: time since last contact at the steering wheel */
# 132 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DA_HOD/src/USS_DA_HOD.c"
/**************************************************************************************************\
    GLOBAL_A2L_MODULE_OUT: mergeable global variables (RAM)
(entspricht MERGEABLE_GLOBAL) | Width: 8
\**************************************************************************************************/
uint8 USS_HOD_s_LatHodIntrp_measure = 0; /* 
    Unit: -
    LSB: 2^0 OFF: 0 MIN/MAX: 0 .. 255
    Description: Current interpretation of the steering wheel contact */
# 149 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DA_HOD/src/USS_DA_HOD.c"
/**************************************************************************************************\
    SLStaticGlobalInit: Default storage class for global static variables with initial value | Width
    : 8
\**************************************************************************************************/
static boolean SUSS_DA_HOD1_DriverActivityDA_HOD_FirstRun = 1;
# 163 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DA_HOD/src/USS_DA_HOD.c"
/**************************************************************************************************\
    SLStaticGlobalInit: Default storage class for global static variables with initial value | Width
    : 16
\**************************************************************************************************/
static uint16 X_SUSS_DA_HOD12_Delay;
# 177 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DA_HOD/src/USS_DA_HOD.c"
/**************************************************************************************************\
    MEASUREMENT: global observable variables (RAM) -- used by Utilities_lib/Measurement | Width: 8
\**************************************************************************************************/
boolean USS_HOD_s_Contact_measure;
...
/**************************************************************************************************\
 ***  FUNCTION:
 ***        USS_DA_HOD_Tab1DnMS0I2T0_USS_DA_HOD
 *** 
 ***  DESCRIPTION:
 ...
 ***        const uint8 *      x_table             vector with x-values
 ***        const uint8 *      z_table             vector with z-values
 ***        uint8              x                   table input
 ***
 ***  RETURNS:
 ***        uint8
 ...
 ***
\**************************************************************************************************/
uint8 USS_DA_HOD_Tab1DnMS0I2T0_USS_DA_HOD(uint8 Nx, const uint8 * x_table, const uint8 * z_table,
  uint8 x)
{
 ...
 ***
\**************************************************************************************************/
                       void USS_DA_HOD(void)
{
    /* SLLocal: Default storage class for local variables | Width: 16 */
    uint16 SUSS_DA_HOD2_Product;

    /* Delay: DriverActivityDA_HOD/CalcInActTi/CountUp/Delay: Check the first run stateDriverActivit
        yDA_HOD/CalcInActTi/CountUp/Delay: Omitted comparison with constant. */
    if (SUSS_DA_HOD1_DriverActivityDA_HOD_FirstRun) {
        /* Delay: DriverActivityDA_HOD/CalcInActTi/CountUp/Delay: Initialize the state */
        X_SUSS_DA_HOD12_Delay = 0;
    }

    /* Switch: DriverActivityDA_HOD/Switch
        DriverActivityDA_HOD/Switch: Omitted comparison with constant. */
    if (USS_GC_s_FlgCpStgWhlPres_measure) {
        /* Switch: DriverActivityDA_HOD/Switch
            # combined # TableLookup: DriverActivityDA_HOD/Look-Up Table HOD
            # combined # TargetLink outport: DriverActivityDA_HOD/USS_HOD_s_LatHodIntrp */
        USS_HOD_s_LatHodIntrp_measure = USS_DA_HOD_Tab1DnMS0I2T0_USS_DA_HOD(16,
         &(USS_HOD_px_LuTblHOD[0]), &(USS_HOD_p1_LuTblHOD[0]), USS_SIH_s_CpStgWhlTch_measure);
    }
    else {
        /* Switch: DriverActivityDA_HOD/Switch
            # combined # TargetLink outport: DriverActivityDA_HOD/USS_HOD_s_LatHodIntrp */
        USS_HOD_s_LatHodIntrp_measure = 12;
    }

    /* Logical: DriverActivityDA_HOD/IntervalDynamic/LogicalOperator
        # combined # DriverActivityDA_HOD/MultiMeasure3/MeasSubsys/Data Type Conversion
        # combined # DriverActivityDA_HOD/MultiMeasure3/Signal Conversion
        # combined # Relational: DriverActivityDA_HOD/IntervalDynamic/RelationalOperatorMin
        # combined # Relational: DriverActivityDA_HOD/IntervalDynamic/RelationalOperatorMax
        # combined # TargetLink outport: DriverActivityDA_HOD/USS_HOD_s_LatHodIntrp
        # combined # TargetLink outport: DriverActivityDA_HOD/USS_HOD_s_LatHodIntrp */
    USS_HOD_s_Contact_measure = (USS_HOD_s_LatHodIntrp_measure < 5) &&
     (USS_HOD_s_LatHodIntrp_measure > 0);

    /* Switch: DriverActivityDA_HOD/CalcInActTi/CountUp/SwitchReset
        DriverActivityDA_HOD/CalcInActTi/CountUp/SwitchReset: Omitted comparison with constant.
        # combined # DriverActivityDA_HOD/MultiMeasure3/MeasSubsys/Data Type Conversion
        # combined # DriverActivityDA_HOD/MultiMeasure3/Signal Conversion */
    if (USS_HOD_s_Contact_measure) {
        /* Switch: DriverActivityDA_HOD/CalcInActTi/CountUp/SwitchReset
            # combined # Delay: DriverActivityDA_HOD/CalcInActTi/CountUp/Delay */
        X_SUSS_DA_HOD12_Delay = 0;
    }
    else {
        /* Switch: DriverActivityDA_HOD/CalcInActTi/CountUp/Switch
            DriverActivityDA_HOD/CalcInActTi/CountUp/Switch: Omitted comparison with constant.
            # combined # Logical: DriverActivityDA_HOD/CalcInActTi/CountUp/LogicalOperator
            # combined # Relational: DriverActivityDA_HOD/CalcInActTi/CountUp/RelationalOperator
            # combined # Logical: DriverActivityDA_HOD/CalcInActTi/Logical Operator
            # combined # DriverActivityDA_HOD/MultiMeasure3/MeasSubsys/Data Type Conversion
            # combined # DriverActivityDA_HOD/MultiMeasure3/Signal Conversion
            # combined # Delay: DriverActivityDA_HOD/CalcInActTi/CountUp/Delay */
        if ((!(USS_HOD_s_Contact_measure)) && (X_SUSS_DA_HOD12_Delay < 25450)) {
            /* Switch: DriverActivityDA_HOD/CalcInActTi/CountUp/Switch
                # combined # Switch: DriverActivityDA_HOD/CalcInActTi/CountUp/SwitchReset
                # combined # Sum: DriverActivityDA_HOD/CalcInActTi/CountUp/Sum
                # combined # Delay: DriverActivityDA_HOD/CalcInActTi/CountUp/Delay
                # combined # Delay: DriverActivityDA_HOD/CalcInActTi/CountUp/Delay */
            X_SUSS_DA_HOD12_Delay = (uint16) (X_SUSS_DA_HOD12_Delay + 1);
        }
    }

    /* Product: DriverActivityDA_HOD/CalcInActTi/Product
        # combined # Delay: DriverActivityDA_HOD/CalcInActTi/CountUp/Delay */
    SUSS_DA_HOD2_Product = (uint16) ((((uint32) X_SUSS_DA_HOD12_Delay) * 41943) >> 21);

    /* Switch: DriverActivityDA_HOD/CalcInActTi/Switch
        DriverActivityDA_HOD/CalcInActTi/Switch: Omitted comparison with constant.
        # combined # Relational: DriverActivityDA_HOD/CalcInActTi/Relational Operator */
    if (SUSS_DA_HOD2_Product <= 507) {
        /* Switch: DriverActivityDA_HOD/CalcInActTi/Switch
            # combined # TargetLink outport: DriverActivityDA_HOD/USS_HOD_s_LatHodNoCntctTi_s */
        USS_HOD_s_LatHodNoCntctTi_s_measure = SUSS_DA_HOD2_Product;
    }
    else {
        /* Switch: DriverActivityDA_HOD/CalcInActTi/Switch
            # combined # TargetLink outport: DriverActivityDA_HOD/USS_HOD_s_LatHodNoCntctTi_s */
        USS_HOD_s_LatHodNoCntctTi_s_measure = 507;
    }

    /* DriverActivityDA_HOD: Reset of the first run state */
    SUSS_DA_HOD1_DriverActivityDA_HOD_FirstRun = 0;
}
