# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DS_DSE/src/UTILS_lib_UssFrqCtrR.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 10 "<built-in>"
...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DS_DSE/src/UTILS_lib_UssFrqCtrR.c" 2
/**************************************************************************************************\
 *** 
 *** Simulink model       : USS_DS_DSE
 *** TargetLink subsystem : USS_DS_DSE/FrameDSE/Subsystem/FrameDSE/DrivingStyleEventsDS_DSE
 *** Codefile             : UTILS_lib_UssFrqCtrR.c
 ***
...
/*----------------------------------------------------------------------------*\
 END OF FILE
\*----------------------------------------------------------------------------*/
# 64 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DS_DSE/src/UTILS_lib_UssFrqCtrR.h" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 628 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DS_DSE/src/UTILS_lib_UssFrqCtrR.c" 2
 ...
 ***        Type               Name                Description
 ***        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ***        boolean            SUssFrqCtrR1_InputSignal_b 
 ***        float32            SUssFrqCtrR1_CountDownStep_s 
 ***        float32            SUssFrqCtrR1_OffD_s 
 ***        uint8 *            SUssFrqCtrR1_Frequency_na 
 ***        ISV_SUssFrqCtrR1_tp * pISV             
 ***
 ***  RETURNS:
 ***        void
 ...
 ***
\**************************************************************************************************/
void USS_FrequencyCounter_RF_step(boolean SUssFrqCtrR1_InputSignal_b, float32
  SUssFrqCtrR1_CountDownStep_s, float32 SUssFrqCtrR1_OffD_s, uint8 * SUssFrqCtrR1_Frequency_na,
  ISV_SUssFrqCtrR1_tp * pISV)
{
    /* SLLocal: Default storage class for local variables | Width: 16 */
    uint16 SUssFrqCtrR1_Divide1;
    uint16 SUssFrqCtrR5_Product;

    /* SLLocal: Default storage class for local variables | Width: 8 */
    boolean SUssFrqCtrR1_Logical_Operator1;
    boolean SUssFrqCtrR3_LogicalOperator;

    /* Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/Frequ
        encyCounterWithCountdown/Reset/CountUp/Delay: Check the first run stateDrivingStyleEventsDS_
        DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/FrequencyCounterWithCountdown/Re
        set/CountUp/Delay: Omitted comparison with constant. */
    if (pISV->SUssFrqCtrR1_FrequencyCounterWithCountdown_FirstRun) {
        /* Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/F
            requencyCounterWithCountdown/Reset/CountUp/Delay: Initialize the state */
        pISV->pISV_SUssFrqCtrR1_0_tp->X_SUssFrqCtrR17_Delay = 0;
    }

    /* Logical: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/Fre
        quencyCounterWithCountdown/EdgeDetectionRising1/LogicalOperator
        # combined # Logical: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrak
        eFrequency/FrequencyCounterWithCountdown/EdgeDetectionRising1/LogicalOperator1 */
    SUssFrqCtrR3_LogicalOperator = (!(pISV->X_SUssFrqCtrR3_UnitDelay)) &&
     SUssFrqCtrR1_InputSignal_b;

    /* Unit delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/
        FrequencyCounterWithCountdown/EdgeDetectionRising1/UnitDelay */
    pISV->X_SUssFrqCtrR3_UnitDelay = SUssFrqCtrR1_InputSignal_b;

    /* Product: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/Fre
        quencyCounterWithCountdown/Divide1 */
    SUssFrqCtrR1_Divide1 = (uint16) (SUssFrqCtrR1_CountDownStep_s / 0.019999999552965164F);

    /* Product: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/Fre
        quencyCounterWithCountdown/Reset/Product */
    SUssFrqCtrR5_Product = (uint16) (SUssFrqCtrR1_Divide1 * 10);

    /* Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/Freq
        uencyCounterWithCountdown/Reset/CountUp/SwitchReset
        DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/FrequencyCo
        unterWithCountdown/Reset/CountUp/SwitchReset: Omitted comparison with constant. */
    if (SUssFrqCtrR3_LogicalOperator) {
        /* Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/
            FrequencyCounterWithCountdown/Reset/CountUp/SwitchReset
            # combined # Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBr
            akeFrequency/FrequencyCounterWithCountdown/Reset/CountUp/Delay */
        pISV->pISV_SUssFrqCtrR1_0_tp->X_SUssFrqCtrR17_Delay = 0;
    }
    else {
        /* Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/
            FrequencyCounterWithCountdown/Reset/CountUp/Switch
            DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/Frequen
            cyCounterWithCountdown/Reset/CountUp/Switch: Omitted comparison with constant.
            # combined # Logical: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Event
            BrakeFrequency/FrequencyCounterWithCountdown/Reset/CountUp/LogicalOperator
            # combined # Relational: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Ev
            entBrakeFrequency/FrequencyCounterWithCountdown/Reset/CountUp/RelationalOperator
            # combined # Logical: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Event
            BrakeFrequency/FrequencyCounterWithCountdown/Reset/Logical Operator2
            # combined # Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBr
            akeFrequency/FrequencyCounterWithCountdown/Reset/CountUp/Delay */
        if ((!(SUssFrqCtrR3_LogicalOperator)) &&
         (pISV->pISV_SUssFrqCtrR1_0_tp->X_SUssFrqCtrR17_Delay < SUssFrqCtrR5_Product)) {
            /* Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFreque
                ncy/FrequencyCounterWithCountdown/Reset/CountUp/Switch
                # combined # Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Ev
                entBrakeFrequency/FrequencyCounterWithCountdown/Reset/CountUp/SwitchReset
                # combined # Sum: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Event
                BrakeFrequency/FrequencyCounterWithCountdown/Reset/CountUp/Sum
                # combined # Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Eve
                ntBrakeFrequency/FrequencyCounterWithCountdown/Reset/CountUp/Delay
                # combined # Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Eve
                ntBrakeFrequency/FrequencyCounterWithCountdown/Reset/CountUp/Delay */
            pISV->pISV_SUssFrqCtrR1_0_tp->X_SUssFrqCtrR17_Delay = (uint16)
             (pISV->pISV_SUssFrqCtrR1_0_tp->X_SUssFrqCtrR17_Delay + 1);
        }
    }

    /* Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/Frequ
        encyCounterWithCountdown/DelayCounters/CountUp/Delay: Check the first run stateDrivingStyleE
        ventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/FrequencyCounterWithCoun
        tdown/DelayCounters/CountUp/Delay: Omitted comparison with constant. */
    if (pISV->SUssFrqCtrR1_FrequencyCounterWithCountdown_FirstRun) {
        /* Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/F
            requencyCounterWithCountdown/DelayCounters/CountUp/Delay: Initialize the state */
        pISV->pISV_SUssFrqCtrR1_0_tp->X_SUssFrqCtrR6_Delay = 1;
    }

    /* Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/Freq
        uencyCounterWithCountdown/DelayCounters/CountUp/SwitchReset
        DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/FrequencyCo
        unterWithCountdown/DelayCounters/CountUp/SwitchReset: Omitted comparison with constant. */
    if (pISV->X_SUssFrqCtrR2_UnitDelay1) {
        /* Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/
            FrequencyCounterWithCountdown/DelayCounters/CountUp/SwitchReset
            # combined # Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBr
            akeFrequency/FrequencyCounterWithCountdown/DelayCounters/CountUp/Delay */
        pISV->pISV_SUssFrqCtrR1_0_tp->X_SUssFrqCtrR6_Delay = 1;
    }
    else {
        /* Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/
            FrequencyCounterWithCountdown/DelayCounters/CountUp/Switch
            DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/Frequen
            cyCounterWithCountdown/DelayCounters/CountUp/Switch: Omitted comparison with constant.
            # combined # Logical: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Event
            BrakeFrequency/FrequencyCounterWithCountdown/DelayCounters/CountUp/LogicalOperator
            # combined # Relational: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Ev
            entBrakeFrequency/FrequencyCounterWithCountdown/DelayCounters/CountUp/RelationalOperator
            # combined # Logical: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Event
            BrakeFrequency/FrequencyCounterWithCountdown/DelayCounters/Logical Operator
            # combined # Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBr
            akeFrequency/FrequencyCounterWithCountdown/DelayCounters/CountUp/Delay */
        if ((!(SUssFrqCtrR3_LogicalOperator)) && (pISV->pISV_SUssFrqCtrR1_0_tp->X_SUssFrqCtrR6_Delay
          < 1600)) {
            /* Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFreque
                ncy/FrequencyCounterWithCountdown/DelayCounters/CountUp/Switch
                # combined # Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Ev
                entBrakeFrequency/FrequencyCounterWithCountdown/DelayCounters/CountUp/SwitchReset
                # combined # Sum: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Event
                BrakeFrequency/FrequencyCounterWithCountdown/DelayCounters/CountUp/Sum
                # combined # Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Eve
                ntBrakeFrequency/FrequencyCounterWithCountdown/DelayCounters/CountUp/Delay
                # combined # Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Eve
                ntBrakeFrequency/FrequencyCounterWithCountdown/DelayCounters/CountUp/Delay */
            pISV->pISV_SUssFrqCtrR1_0_tp->X_SUssFrqCtrR6_Delay = (uint16)
             (pISV->pISV_SUssFrqCtrR1_0_tp->X_SUssFrqCtrR6_Delay + 1);
        }
    }

    /* Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/Frequ
        encyCounterWithCountdown/DelayCounters/CountUp1/Delay: Check the first run stateDrivingStyle
        EventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/FrequencyCounterWithCou
        ntdown/DelayCounters/CountUp1/Delay: Omitted comparison with constant. */
    if (pISV->SUssFrqCtrR1_FrequencyCounterWithCountdown_FirstRun) {
        /* Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/F
            requencyCounterWithCountdown/DelayCounters/CountUp1/Delay: Initialize the state */
        pISV->pISV_SUssFrqCtrR1_0_tp->X_SUssFrqCtrR7_Delay = 1;
    }

    /* Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/Freq
        uencyCounterWithCountdown/DelayCounters/CountUp1/SwitchReset
        DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/FrequencyCo
        unterWithCountdown/DelayCounters/CountUp1/SwitchReset: Omitted comparison with constant. */
    if (SUssFrqCtrR3_LogicalOperator) {
        /* Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/
            FrequencyCounterWithCountdown/DelayCounters/CountUp1/SwitchReset
            # combined # Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBr
            akeFrequency/FrequencyCounterWithCountdown/DelayCounters/CountUp1/Delay */
        pISV->pISV_SUssFrqCtrR1_0_tp->X_SUssFrqCtrR7_Delay = 1;
    }
    else {
        /* Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/
            FrequencyCounterWithCountdown/DelayCounters/CountUp1/Switch
            DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/Frequen
            cyCounterWithCountdown/DelayCounters/CountUp1/Switch: Omitted comparison with constant.
            # combined # Logical: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Event
            BrakeFrequency/FrequencyCounterWithCountdown/DelayCounters/CountUp1/LogicalOperator
            # combined # Relational: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Ev
            entBrakeFrequency/FrequencyCounterWithCountdown/DelayCounters/CountUp1/RelationalOperato
            r
            # combined # Logical: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Event
            BrakeFrequency/FrequencyCounterWithCountdown/DelayCounters/Logical Operator1
            # combined # Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBr
            akeFrequency/FrequencyCounterWithCountdown/DelayCounters/CountUp1/Delay */
        if ((!(SUssFrqCtrR3_LogicalOperator)) && (pISV->pISV_SUssFrqCtrR1_0_tp->X_SUssFrqCtrR7_Delay
          < 50050)) {
            /* Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFreque
                ncy/FrequencyCounterWithCountdown/DelayCounters/CountUp1/Switch
                # combined # Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Ev
                entBrakeFrequency/FrequencyCounterWithCountdown/DelayCounters/CountUp1/SwitchReset
                # combined # Sum: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Event
                BrakeFrequency/FrequencyCounterWithCountdown/DelayCounters/CountUp1/Sum
                # combined # Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Eve
                ntBrakeFrequency/FrequencyCounterWithCountdown/DelayCounters/CountUp1/Delay
                # combined # Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Eve
                ntBrakeFrequency/FrequencyCounterWithCountdown/DelayCounters/CountUp1/Delay */
            pISV->pISV_SUssFrqCtrR1_0_tp->X_SUssFrqCtrR7_Delay = (uint16)
             (pISV->pISV_SUssFrqCtrR1_0_tp->X_SUssFrqCtrR7_Delay + 1);
        }
    }

    /* Logical: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/Fre
        quencyCounterWithCountdown/Logical Operator1
        # combined # DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequenc
        y/FrequencyCounterWithCountdown/Rescaler
        # combined # Relational: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventB
        rakeFrequency/FrequencyCounterWithCountdown/Relational Operator1
        # combined # Relational: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventB
        rakeFrequency/FrequencyCounterWithCountdown/Relational Operator
        # combined # Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeF
        requency/FrequencyCounterWithCountdown/DelayCounters/CountUp/Delay
        # combined # Product: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrak
        eFrequency/FrequencyCounterWithCountdown/Divide
        # combined # Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeF
        requency/FrequencyCounterWithCountdown/DelayCounters/CountUp1/Delay */
    SUssFrqCtrR1_Logical_Operator1 = (SUssFrqCtrR1_Divide1 <=
     pISV->pISV_SUssFrqCtrR1_0_tp->X_SUssFrqCtrR6_Delay) &&
     (pISV->pISV_SUssFrqCtrR1_0_tp->X_SUssFrqCtrR7_Delay > ((uint16) (SUssFrqCtrR1_OffD_s /
     0.019999999552965164F))) && (pISV->X_SUssFrqCtrR1_UnitDelay != 0);

    /* Unit delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/
        FrequencyCounterWithCountdown/DelayCounters/UnitDelay1
        # combined # Logical: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrak
        eFrequency/FrequencyCounterWithCountdown/DelayCounters/Logical Operator2 */
    pISV->X_SUssFrqCtrR2_UnitDelay1 = SUssFrqCtrR3_LogicalOperator ||
     SUssFrqCtrR1_Logical_Operator1;

    /* Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/Freq
        uencyCounterWithCountdown/Switch3
        DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/FrequencyCo
        unterWithCountdown/Switch3: Omitted comparison with constant.
        # combined # Relational: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventB
        rakeFrequency/FrequencyCounterWithCountdown/Reset/Relational Operator2
        # combined # Delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeF
        requency/FrequencyCounterWithCountdown/Reset/CountUp/Delay */
    if (pISV->pISV_SUssFrqCtrR1_0_tp->X_SUssFrqCtrR17_Delay == SUssFrqCtrR5_Product) {
        /* Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/
            FrequencyCounterWithCountdown/Switch3
            # combined # Unit delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Ev
            entBrakeFrequency/FrequencyCounterWithCountdown/UnitDelay */
        pISV->X_SUssFrqCtrR1_UnitDelay = 0;
    }
    else {
        /* SLLocal: Default storage class for local variables | Width: 8 */
        uint8 SUssFrqCtrR4_Switch;

        /* Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/
            FrequencyCounterWithCountdown/IncrementCalculation/Switch
            DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/Frequen
            cyCounterWithCountdown/IncrementCalculation/Switch: Omitted comparison with constant. */
        if (SUssFrqCtrR3_LogicalOperator) {
            /* Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFreque
                ncy/FrequencyCounterWithCountdown/IncrementCalculation/Switch
                # combined # Sum: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Event
                BrakeFrequency/FrequencyCounterWithCountdown/IncrementCalculation/Sum */
            SUssFrqCtrR4_Switch = (uint8) (pISV->X_SUssFrqCtrR1_UnitDelay + 1);
        }
        else {
            /* Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFreque
                ncy/FrequencyCounterWithCountdown/IncrementCalculation/Switch3
                DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/Fre
                quencyCounterWithCountdown/IncrementCalculation/Switch3: Omitted comparison with con
                stant. */
            if (SUssFrqCtrR1_Logical_Operator1) {
                /* Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFr
                    equency/FrequencyCounterWithCountdown/IncrementCalculation/Switch3
                    # combined # Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvent
                    s/EventBrakeFrequency/FrequencyCounterWithCountdown/IncrementCalculation/Switch
                    # combined # Sum: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/E
                    ventBrakeFrequency/FrequencyCounterWithCountdown/IncrementCalculation/Sum1 */
                SUssFrqCtrR4_Switch = (uint8) (pISV->X_SUssFrqCtrR1_UnitDelay - 1);
            }
            else {
                /* Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFr
                    ...
                    s/EventBrakeFrequency/FrequencyCounterWithCountdown/IncrementCalculation/Switch
                     */
                SUssFrqCtrR4_Switch = pISV->X_SUssFrqCtrR1_UnitDelay;
            }
        }

        /* MinMax: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/
            FrequencyCounterWithCountdown/MinMax */
        if (SUssFrqCtrR4_Switch < 100) {
            /* # combined # Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Eve
                ntBrakeFrequency/FrequencyCounterWithCountdown/Switch3
                # combined # Unit delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvent
                s/EventBrakeFrequency/FrequencyCounterWithCountdown/UnitDelay */
            pISV->X_SUssFrqCtrR1_UnitDelay = SUssFrqCtrR4_Switch;
        }
        else {
            /* # combined # Switch: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/Eve
                ntBrakeFrequency/FrequencyCounterWithCountdown/Switch3
                # combined # Unit delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvent
                s/EventBrakeFrequency/FrequencyCounterWithCountdown/UnitDelay */
            pISV->X_SUssFrqCtrR1_UnitDelay = 100;
        }
    }

    /* TargetLink outport: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFr
        equency/FrequencyCounterWithCountdown/Frequency_na
        # combined # Unit delay: DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventB
        rakeFrequency/FrequencyCounterWithCountdown/UnitDelay */
    *SUssFrqCtrR1_Frequency_na = pISV->X_SUssFrqCtrR1_UnitDelay;

    /* DrivingStyleEventsDS_DSE/EventCalculation_DS_DSE/PedalEvents/EventBrakeFrequency/FrequencyCou
        nterWithCountdown: Reset of the first run state */
    pISV->SUssFrqCtrR1_FrequencyCounterWithCountdown_FirstRun = 0;
}
