# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DS_EFF_stub.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 10 "<built-in>"
...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DS_EFF_stub.c" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 2 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DS_EFF_stub.c" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 3 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DS_EFF_stub.c" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/rte\\USSDB_MemMap.h" 1
# 4 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DS_EFF_stub.c" 2
void USS_DS_EFF_stub(void)
{
 __ASTREE_check(( USS_DSE_s_BitFldEveEff_measure >= 0 && USS_DSE_s_BitFldEveEff_measure <= 65535 ));
 __ASTREE_check(( USS_DSE_s_EveFactorLgtAHi_measure >= 0.F && USS_DSE_s_EveFactorLgtAHi_measure <= 1.F ));
 __ASTREE_check(( USS_IP_s_FacRgn_measure >= 0 && USS_IP_s_FacRgn_measure <= 100 ));
 __ASTREE_check(( USS_IP_s_FacShiftPedDwnEff_measure >= 0 && USS_IP_s_FacShiftPedDwnEff_measure <= 100 ));
 __ASTREE_check(( USS_IP_s_FacShiftPedUp_measure >= 0 && USS_IP_s_FacShiftPedUp_measure <= 100 ));
 __ASTREE_modify(( USS_EFF_s_EffLvl_p100_measure; [0 ,100] ));
 __ASTREE_modify(( USS_EFF_s_IdxEff_measure; [-1000.F ,50000.F] ));
}
