# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_ID_IF_stub.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 10 "<built-in>"
...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_ID_IF_stub.c" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 2 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_ID_IF_stub.c" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 3 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_ID_IF_stub.c" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/rte\\USSDB_MemMap.h" 1
# 4 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_ID_IF_stub.c" 2
void USS_ID_IF_stub(void)
{
 __ASTREE_check(( USS_IIAA_s_IdcCnfd_measure >= 0.F && USS_IIAA_s_IdcCnfd_measure <= 100.F ));
 __ASTREE_check(( USS_IIEC_s_IndicatorConf_measure >= 0.F && USS_IIEC_s_IndicatorConf_measure <= 100.F ));
 __ASTREE_check(( USS_IILK_s_IndicatorConf_measure >= 0.F && USS_IILK_s_IndicatorConf_measure <= 100.F ));
 __ASTREE_check(( USS_IIRT_s_IndicatorConf_measure >= 0.F && USS_IIRT_s_IndicatorConf_measure <= 100.F ));
 __ASTREE_check(( USS_IIVE_s_IdcCnfd_measure >= 0.F && USS_IIVE_s_IdcCnfd_measure <= 100.F ));
 __ASTREE_modify(( USS_IIF_s_ImpairLevel_measure; [0 ,7] ));
 __ASTREE_modify(( USS_IIF_s_ImpairLevelConf_measure; [0 ,7] ));
 __ASTREE_modify(( USS_IIF_s_ImpairLevel_ErrFlg_measure; [0 ,1] ));
}
