# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DS_DSE_stub.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 10 "<built-in>"
...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DS_DSE_stub.c" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DS_DSE/src\\tl_defines_USS_DS_DSE.h" 1
/**************************************************************************************************\
 *** 
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 2 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DS_DSE_stub.c" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 3 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DS_DSE_stub.c" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 4 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DS_DSE_stub.c" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/rte\\USSDB_MemMap.h" 1
# 5 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DS_DSE_stub.c" 2
void USS_DS_DSE_stub(void)
{
 __ASTREE_check(( USS_GC_s_AgStg_deg_measure >= -819.F && USS_GC_s_AgStg_deg_measure <= 819.3800048828125F ));
 __ASTREE_check(( USS_GC_s_LeadVehTiDist_s_measure >= 0.F && USS_GC_s_LeadVehTiDist_s_measure <= 60.F ));
 __ASTREE_check(( USS_GC_s_MaxSignVLim_kmph_measure >= 0.F && USS_GC_s_MaxSignVLim_kmph_measure <= 255.F ));
 __ASTREE_check(( USS_GC_s_VDSOLgtAFil_mps2_measure >= -163.839996337890625F && USS_GC_s_VDSOLgtAFil_mps2_measure <= 163.839996337890625F ));
 __ASTREE_check(( USS_GC_s_VDSOVLgt_kmph_measure >= -460.100006103515625F && USS_GC_s_VDSOVLgt_kmph_measure <= 460.100006103515625F ));
 __ASTREE_check(( USS_HOD_s_LatHodIntrp_measure >= 0 && USS_HOD_s_LatHodIntrp_measure <= 15 ));
 __ASTREE_check(( USS_SIH_s_ACADxObj01_m_measure >= 0.F && USS_SIH_s_ACADxObj01_m_measure <= 255.875F ));
 __ASTREE_check(( USS_SIH_s_ACAStLat_measure >= 0 && USS_SIH_s_ACAStLat_measure <= 7 ));
 __ASTREE_check(( USS_SIH_s_ACAStLgt_measure >= 0 && USS_SIH_s_ACAStLgt_measure <= 7 ));
 __ASTREE_check(( USS_SIH_s_ACCStLgt_measure >= 0 && USS_SIH_s_ACCStLgt_measure <= 3 ));
 __ASTREE_check(( USS_SIH_s_APIStDrvPed_measure >= 0 && USS_SIH_s_APIStDrvPed_measure <= 2 ));
 __ASTREE_check(( USS_SIH_s_DBRIdcDrvBrk_measure >= 0 && USS_SIH_s_DBRIdcDrvBrk_measure <= 7 ));
 __ASTREE_check(( USS_SIH_s_DrvDrgIdxRgnLvl_measure >= 0 && USS_SIH_s_DrvDrgIdxRgnLvl_measure <= 15 ));
 __ASTREE_check(( USS_SIH_s_ESCOffBtn_measure >= 0 && USS_SIH_s_ESCOffBtn_measure <= 3 ));
 __ASTREE_check(( USS_SIH_s_GearShift_measure >= 0 && USS_SIH_s_GearShift_measure <= 15 ));
 __ASTREE_check(( USS_SIH_s_LimGraAccAca_measure >= 0 && USS_SIH_s_LimGraAccAca_measure <= 4 ));
 __ASTREE_check(( USS_SIH_s_RGDInsCity_measure >= 0 && USS_SIH_s_RGDInsCity_measure <= 40000 ));
 __ASTREE_check(( USS_SIH_s_RGDRoundabout_measure >= 0 && USS_SIH_s_RGDRoundabout_measure <= 40000 ));
 __ASTREE_check(( USS_SIH_s_RGIdInsCity_measure >= 0 && USS_SIH_s_RGIdInsCity_measure <= 255 ));
 __ASTREE_check(( USS_SIH_s_RGIdRoundabout_measure >= 0 && USS_SIH_s_RGIdRoundabout_measure <= 255 ));
 __ASTREE_check(( USS_SIH_s_RGSrcInsCity_measure >= 0 && USS_SIH_s_RGSrcInsCity_measure <= 255 ));
 __ASTREE_check(( USS_SIH_s_RGSrcRoundabout_measure >= 0 && USS_SIH_s_RGSrcRoundabout_measure <= 255 ));
 __ASTREE_check(( USS_SIH_s_VDSOLatA_mps2_measure >= -163.839996337890625F && USS_SIH_s_VDSOLatA_mps2_measure <= 163.839996337890625F ));
 __ASTREE_check(( USS_SIH_s_VDSOVLgt_mps_measure >= -127.8000030517578125F && USS_SIH_s_VDSOVLgt_mps_measure <= 127.8000030517578125F ));
 __ASTREE_check(( USS_SIH_s_VMMBrkPedItDmdNorm_measure >= 0.F && USS_SIH_s_VMMBrkPedItDmdNorm_measure <= 4.090000152587890625F ));
 __ASTREE_check(( USS_SIH_s_VMMBrkPedStReqDmnt_measure >= 0 && USS_SIH_s_VMMBrkPedStReqDmnt_measure <= 3 ));
 __ASTREE_check(( USS_SIH_s_VMMDrvPedADmdNorm_measure >= -6.400000095367431640625F && USS_SIH_s_VMMDrvPedADmdNorm_measure <= 14.F ));
 __ASTREE_modify(( USS_DSE_s_BitFldEveCom_measure; [0 ,65535] ));
 __ASTREE_modify(( USS_DSE_s_BitFldEveDyn_measure; [0 ,65535] ));
 __ASTREE_modify(( USS_DSE_s_BitFldEveEff_measure; [0 ,65535] ));
 __ASTREE_modify(( USS_DSE_s_EveFactorLatAHi_measure; [0.F ,1.F] ));
 __ASTREE_modify(( USS_DSE_s_EveFactorLgtAHi_measure; [0.F ,1.F] ));
}
