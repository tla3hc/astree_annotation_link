# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_ID_PRP_stub.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 10 "<built-in>"
...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_ID_PRP_stub.c" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 2 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_ID_PRP_stub.c" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 3 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_ID_PRP_stub.c" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/rte\\USSDB_MemMap.h" 1
# 4 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_ID_PRP_stub.c" 2
void USS_ID_PRP_stub(void)
{
 __ASTREE_check(( USS_DSE_s_BitFldEveDyn_measure >= 0 && USS_DSE_s_BitFldEveDyn_measure <= 65535 ));
 __ASTREE_check(( USS_DSE_s_EveFactorLatAHi_measure >= 0.F && USS_DSE_s_EveFactorLatAHi_measure <= 1.F ));
 __ASTREE_check(( USS_GC_s_AgStg_deg_measure >= -819.F && USS_GC_s_AgStg_deg_measure <= 819.3800048828125F ));
 __ASTREE_check(( USS_GC_s_BrkFrq_measure >= 0 && USS_GC_s_BrkFrq_measure <= 255 ));
 ...
 __ASTREE_check(( USS_GC_s_StgFrq_measure >= 0 && USS_GC_s_StgFrq_measure <= 255 ));
 ...
 __ASTREE_check(( USS_SIH_s_LDALine00HorDistY_m_measure >= -32.F && USS_SIH_s_LDALine00HorDistY_m_measure <= 32.F ));
 __ASTREE_check(( USS_SIH_s_LDALine00Safe_measure >= 0 && USS_SIH_s_LDALine00Safe_measure <= 3 ));
 __ASTREE_check(( USS_SIH_s_LDALine01HorDistY_m_measure >= -32.F && USS_SIH_s_LDALine01HorDistY_m_measure <= 32.F ));
 __ASTREE_check(( USS_SIH_s_LDALine01Safe_measure >= 0 && USS_SIH_s_LDALine01Safe_measure <= 3 ));
 __ASTREE_check(( USS_SIH_s_LDALine02HorDistY_m_measure >= -32.F && USS_SIH_s_LDALine02HorDistY_m_measure <= 32.F ));
 __ASTREE_check(( USS_SIH_s_LDALine02Safe_measure >= 0 && USS_SIH_s_LDALine02Safe_measure <= 3 ));
 __ASTREE_check(( USS_SIH_s_LDAStatus_measure >= 0 && USS_SIH_s_LDAStatus_measure <= 7 ));
 __ASTREE_check(( USS_SIH_s_RGTrfcLghtDst_dm_measure >= 0 && USS_SIH_s_RGTrfcLghtDst_dm_measure <= 40000 ));
 __ASTREE_check(( USS_SIH_s_RGTrfcMovmtPhaSt_measure >= 0 && USS_SIH_s_RGTrfcMovmtPhaSt_measure <= 10 ));
 ...
 __ASTREE_modify(( USS_IPR_s_AcclOvtkReq_measure; [0 ,1] ));
 __ASTREE_modify(( USS_IPR_s_LeadVehBrk_measure; [0 ,1] ));
 __ASTREE_modify(( USS_IPR_s_SddnAccl_measure; [0 ,1] ));
 __ASTREE_modify(( USS_IPR_s_SddnBrkSig_measure; [0 ,1] ));
 __ASTREE_modify(( USS_IPR_s_SddnStg_measure; [0 ,1] ));
 __ASTREE_modify(( USS_IPR_s_StartTrgGreenTrffcLght_measure; [0 ,1] ));
 __ASTREE_modify(( USS_IPR_s_StartTrgRedTrffcLght_measure; [0 ,1] ));
 __ASTREE_modify(( USS_IPR_s_StartTrgSdnLeadVeh_measure; [0 ,1] ));
 __ASTREE_modify(( USS_IPR_s_StopTrgGreenTrffcLght_measure; [0 ,1] ));
 __ASTREE_modify(( USS_IPR_s_StopTrgRedTrffcLght_measure; [0 ,1] ));
 __ASTREE_modify(( USS_IPR_s_StopTrgSdnLeadVeh_measure; [0 ,1] ));
 __ASTREE_modify(( USS_IPR_s_VehStopSig_measure; [0 ,1] ));
 __ASTREE_modify(( USS_IPR_s_VehStrtSig_measure; [0 ,1] ));
 __ASTREE_modify(( USS_IPR_s_lineOffset_measure; [0.F ,32.F] ));
 __ASTREE_modify(( USS_IPR_s_lineValid_measure; [0 ,1] ));
}
