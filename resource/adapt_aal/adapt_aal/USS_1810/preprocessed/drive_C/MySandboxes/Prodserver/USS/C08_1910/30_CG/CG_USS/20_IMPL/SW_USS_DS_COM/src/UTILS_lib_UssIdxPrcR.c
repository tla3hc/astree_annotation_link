# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DS_COM/src/UTILS_lib_UssIdxPrcR.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 10 "<built-in>"
...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DS_COM/src/UTILS_lib_UssIdxPrcR.c" 2
/**************************************************************************************************\
 *** 
 *** Simulink model       : USS_DS_COM
 *** TargetLink subsystem : USS_DS_COM/FrameCOM/Subsystem/FrameCOM/ComfortableDS_COM
 *** Codefile             : UTILS_lib_UssIdxPrcR.c
 ***
...
/*----------------------------------------------------------------------------*\
 END OF FILE
\*----------------------------------------------------------------------------*/
# 64 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DS_COM/src/UTILS_lib_UssIdxPrcR.h" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 764 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DS_COM/src/UTILS_lib_UssIdxPrcR.c" 2
...
/**************************************************************************************************\
    TL_CG_MACROCL_GLOBAL_OMIT_CASTSrToModuleLocal_USS_DS_COM: TL CG ScopeReducedClass : derived from
     TL_CG_MACROCL_GLOBAL_OMIT_CAST
\**************************************************************************************************/
 ...
 ***        Type               Name                Description
 ***        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ***        boolean            SUssIdxPrcR1_Event_b 
 ***        float32            SUssIdxPrcR1_Factor_na 
 ***        float32            SUssIdxPrcR1_Offdelay_tk 
 ***        boolean            SUssIdxPrcR1_VehicleIsMoving_b 
 ***        float32 *          SUssIdxPrcR1_IndexOut_na 
 ***        ISV_SUssIdxPrcR1_tp * pISV             
 ***
 ***  RETURNS:
 ***        void
 ***
 ...
 ***
\**************************************************************************************************/
void USS_IndexProcressing_RF_step(boolean SUssIdxPrcR1_Event_b, float32 SUssIdxPrcR1_Factor_na,
  float32 SUssIdxPrcR1_Offdelay_tk, boolean SUssIdxPrcR1_VehicleIsMoving_b, float32 *
  SUssIdxPrcR1_IndexOut_na, ISV_SUssIdxPrcR1_tp * pISV)
{
    /* SLLocal: Default storage class for local variables | Width: 32 */
    float32 SUssIdxPrcR1_Add1;
    float32 SUssIdxPrcR1_Multiport_Switch;
    float32 SUssIdxPrcR2_Switch1;

    if (pISV->CUssIdxPrcR1_Counter_ctr < 2147483647) {
        pISV->CUssIdxPrcR1_Counter_ctr = pISV->CUssIdxPrcR1_Counter_ctr + 1;
    }

    /* Counter for event
        Counter */

    /* Begin execution of chart ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/IndexProces
        sing/Counter */
    switch (pISV->CUssIdxPrcR1_Counter_ns) {
        case 1: {
            /* Begin execution of state ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/Ind
                exProcessing/Counter.COUNTER_START */

            /* # combined # update of variable(s) associated with ComfortableDS_COM/IndexProcessing/
                IndexBrakeFrequencyLow/IndexProcessing/Event_b */
            if (!(SUssIdxPrcR1_Event_b)) {
                /* State transition from ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/In
                    dexProcessing/Counter.COUNTER_START to ComfortableDS_COM/IndexProcessing/IndexBr
                    akeFrequencyLow/IndexProcessing/Counter.COUNTER_START */
                pISV->CUssIdxPrcR1_Counter_ns = 1;
                pISV->CUssIdxPrcR1_CounterTrigger_na = 0;
            }
            else {
                /* State transition from ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/In
                    dexProcessing/Counter.COUNTER_START to ComfortableDS_COM/IndexProcessing/IndexBr
                    akeFrequencyLow/IndexProcessing/Counter.COUNTER_COUNTUP */
                pISV->CUssIdxPrcR1_Counter_ns = 5;
                pISV->CUssIdxPrcR1_CounterTrigger_na = 1;
            }

            /* End execution of state ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/Index
                Processing/Counter.COUNTER_START */
            break;
        }
        case 2: {
            /* Begin execution of state ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/Ind
                exProcessing/Counter.COUNTER_HOLD */

            /* # combined # update of variable(s) associated with ComfortableDS_COM/IndexProcessing/
                IndexBrakeFrequencyLow/IndexProcessing/Event_b */
            if (SUssIdxPrcR1_Event_b) {
                /* State transition from ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/In
                    dexProcessing/Counter.COUNTER_HOLD to ComfortableDS_COM/IndexProcessing/IndexBra
                    keFrequencyLow/IndexProcessing/Counter.COUNTER_HOLD */
                pISV->CUssIdxPrcR1_Counter_ns = 2;
                pISV->CUssIdxPrcR1_CounterTrigger_na = 2;
            }
            else {
                /* State transition from ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/In
                    dexProcessing/Counter.COUNTER_HOLD to ComfortableDS_COM/IndexProcessing/IndexBra
                    keFrequencyLow/IndexProcessing/Counter.COUNTER_HOLDTWO */
                pISV->CUssIdxPrcR1_Counter_ctr = 0;
                pISV->CUssIdxPrcR1_Counter_ns = 3;
                pISV->CUssIdxPrcR1_CounterTrigger_na = 2;
            }

            /* End execution of state ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/Index
                Processing/Counter.COUNTER_HOLD */
            break;
        }
        case 3: {
            /* Begin execution of state ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/Ind
                exProcessing/Counter.COUNTER_HOLDTWO */

            /* # combined # update of variable(s) associated with ComfortableDS_COM/IndexProcessing/
                IndexBrakeFrequencyLow/IndexProcessing/Offdelay_tk */
            if (pISV->CUssIdxPrcR1_Counter_ctr >= ((uint32) SUssIdxPrcR1_Offdelay_tk)) {
                /* State transition from ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/In
                    dexProcessing/Counter.COUNTER_HOLDTWO to ComfortableDS_COM/IndexProcessing/Index
                    BrakeFrequencyLow/IndexProcessing/Counter.HOLD_STILLSTAND */
                pISV->CUssIdxPrcR1_Counter_ns = 4;
                pISV->CUssIdxPrcR1_CounterTrigger_na = 2;
            }
            else {
                /* # combined # update of variable(s) associated with ComfortableDS_COM/IndexProcess
                    ing/IndexBrakeFrequencyLow/IndexProcessing/Event_b */
                if (SUssIdxPrcR1_Event_b) {
                    /* State transition from ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLo
                        w/IndexProcessing/Counter.COUNTER_HOLDTWO to ComfortableDS_COM/IndexProcessi
                        ng/IndexBrakeFrequencyLow/IndexProcessing/Counter.COUNTER_COUNTUP */
                    pISV->CUssIdxPrcR1_Counter_ns = 5;
                    pISV->CUssIdxPrcR1_CounterTrigger_na = 1;
                }
            }
            ...
            /* End execution of state ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/Index
                Processing/Counter.COUNTER_HOLDTWO */
            break;
        }
        case 4: {
            /* Begin execution of state ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/Ind
            ...
            /* # combined # update of variable(s) associated with ComfortableDS_COM/IndexProcessing/
                IndexBrakeFrequencyLow/IndexProcessing/VehicleIsMoving_b */
            if (!(SUssIdxPrcR1_VehicleIsMoving_b)) {
                /* State transition from ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/In
                    dexProcessing/Counter.HOLD_STILLSTAND to ComfortableDS_COM/IndexProcessing/Index
                    BrakeFrequencyLow/IndexProcessing/Counter.HOLD_STILLSTAND */
                pISV->CUssIdxPrcR1_Counter_ns = 4;
                pISV->CUssIdxPrcR1_CounterTrigger_na = 2;
            }
                ...
                /* State transition from ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/In
                    dexProcessing/Counter.HOLD_STILLSTAND to ComfortableDS_COM/IndexProcessing/Index
                    BrakeFrequencyLow/IndexProcessing/Counter.COUNTER_COUNTDOWN */
                pISV->CUssIdxPrcR1_Counter_ns = 6;
                pISV->CUssIdxPrcR1_CounterTrigger_na = 3;
            }

            /* End execution of state ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/Index
                Processing/Counter.HOLD_STILLSTAND */
            break;
        }
        case 5: {
            /* Begin execution of state ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/Ind
                exProcessing/Counter.COUNTER_COUNTUP */

            /* # combined # update of variable(s) associated with ComfortableDS_COM/IndexProcessing/
                IndexBrakeFrequencyLow/IndexProcessing/Factor_na */
            if (SUssIdxPrcR1_Factor_na <= pISV->X_SUssIdxPrcR1_Unit_Delay) {
                /* State transition from ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/In
                    dexProcessing/Counter.COUNTER_COUNTUP to ComfortableDS_COM/IndexProcessing/Index
                    BrakeFrequencyLow/IndexProcessing/Counter.COUNTER_HOLD */
                pISV->CUssIdxPrcR1_Counter_ns = 2;
                pISV->CUssIdxPrcR1_CounterTrigger_na = 2;
            }
            else {
                /* # combined # update of variable(s) associated with ComfortableDS_COM/IndexProcess
                    ing/IndexBrakeFrequencyLow/IndexProcessing/Event_b
                    # combined # update of variable(s) associated with ComfortableDS_COM/IndexProces
                    sing/IndexBrakeFrequencyLow/IndexProcessing/Factor_na */
                if (SUssIdxPrcR1_Event_b && (SUssIdxPrcR1_Factor_na >
                 pISV->X_SUssIdxPrcR1_Unit_Delay)) {
                    /* State transition from ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLo
                        w/IndexProcessing/Counter.COUNTER_COUNTUP to ComfortableDS_COM/IndexProcessi
                        ng/IndexBrakeFrequencyLow/IndexProcessing/Counter.COUNTER_COUNTUP */
                    pISV->CUssIdxPrcR1_Counter_ns = 5;
                    pISV->CUssIdxPrcR1_CounterTrigger_na = 1;
                }
                else {
                    /* # combined # update of variable(s) associated with ComfortableDS_COM/IndexPro
                        cessing/IndexBrakeFrequencyLow/IndexProcessing/Event_b */
                    if (!(SUssIdxPrcR1_Event_b)) {
                        /* State transition from ComfortableDS_COM/IndexProcessing/IndexBrakeFrequen
                            cyLow/IndexProcessing/Counter.COUNTER_COUNTUP to ComfortableDS_COM/Index
                            Processing/IndexBrakeFrequencyLow/IndexProcessing/Counter.COUNTER_HOLDTW
                            O */
                        pISV->CUssIdxPrcR1_Counter_ctr = 0;
                        pISV->CUssIdxPrcR1_Counter_ns = 3;
                        pISV->CUssIdxPrcR1_CounterTrigger_na = 2;
            ...
            /* End execution of state ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/Index
                Processing/Counter.COUNTER_COUNTUP */
            break;
        }
        case 6: {
            /* Begin execution of state ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/Ind
                exProcessing/Counter.COUNTER_COUNTDOWN */
            if (pISV->X_SUssIdxPrcR1_Unit_Delay == 0.F) {
                /* State transition from ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/In
                    dexProcessing/Counter.COUNTER_COUNTDOWN to ComfortableDS_COM/IndexProcessing/Ind
                    exBrakeFrequencyLow/IndexProcessing/Counter.COUNTER_START */
                pISV->CUssIdxPrcR1_Counter_ns = 1;
                pISV->CUssIdxPrcR1_CounterTrigger_na = 0;
            }
            else {
                ...
                if (SUssIdxPrcR1_Event_b) {
                    /* State transition from ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLo
                        w/IndexProcessing/Counter.COUNTER_COUNTDOWN to ComfortableDS_COM/IndexProces
                        sing/IndexBrakeFrequencyLow/IndexProcessing/Counter.COUNTER_COUNTUP */
                    pISV->CUssIdxPrcR1_Counter_ns = 5;
                    pISV->CUssIdxPrcR1_CounterTrigger_na = 1;
                }
                else {
                    /* # combined # update of variable(s) associated with ComfortableDS_COM/IndexPro
                        cessing/IndexBrakeFrequencyLow/IndexProcessing/VehicleIsMoving_b */
                    if (!(SUssIdxPrcR1_VehicleIsMoving_b)) {
                        /* State transition from ComfortableDS_COM/IndexProcessing/IndexBrakeFrequen
                            cyLow/IndexProcessing/Counter.COUNTER_COUNTDOWN to ComfortableDS_COM/Ind
                            exProcessing/IndexBrakeFrequencyLow/IndexProcessing/Counter.HOLD_STILLST
                            AND */
                        pISV->CUssIdxPrcR1_Counter_ns = 4;
                        pISV->CUssIdxPrcR1_CounterTrigger_na = 2;
                    }
            ...
            /* End execution of state ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/Index
                Processing/Counter.COUNTER_COUNTDOWN */
            break;
        }
        default: {
            /* State transition to ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/IndexPro
                cessing/Counter.COUNTER_START */
            pISV->CUssIdxPrcR1_Counter_ns = 1;
            pISV->CUssIdxPrcR1_CounterTrigger_na = 0;
            break;
        }
    }
    /* End execution of chart ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/IndexProcessi
        ng/Counter */

    /* Multiport switch: ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/IndexProcessing/Mu
        ltiport Switch */
    switch (pISV->CUssIdxPrcR1_CounterTrigger_na) {
        case 1: {
            /* # combined # update of variable(s) associated with ComfortableDS_COM/IndexProcessing/
                IndexBrakeFrequencyLow/IndexProcessing/Factor_na */
            SUssIdxPrcR1_Multiport_Switch = SUssIdxPrcR1_Factor_na;
            break;
        }
        case 2: {
            SUssIdxPrcR1_Multiport_Switch = 0.F;
            break;
        }
        default: {
            SUssIdxPrcR1_Multiport_Switch = -0.0010000000474974513F;
            break;
        }
    }

    /* Sum: ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/IndexProcessing/Add1 */
    SUssIdxPrcR1_Add1 = SUssIdxPrcR1_Multiport_Switch + pISV->X_SUssIdxPrcR1_Unit_Delay;

    /* Switch: ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/IndexProcessing/SaturationDy
        namic/Switch1
        ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/IndexProcessing/SaturationDynamic/S
        witch1: Omitted comparison with constant.
        # combined # Relational: ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/IndexProce
        ssing/SaturationDynamic/RelationalOperator1 */
    if (SUssIdxPrcR1_Add1 < 0.F) {
        /* Switch: ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/IndexProcessing/Saturati
            onDynamic/Switch1 */
        SUssIdxPrcR2_Switch1 = 0.F;
    }
    else {
        /* Switch: ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/IndexProcessing/Saturati
            onDynamic/Switch1 */
        SUssIdxPrcR2_Switch1 = SUssIdxPrcR1_Add1;
    }
    ...
    /* Switch: ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/IndexProcessing/SaturationDy
        ...
        # combined # Relational: ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/IndexProce
        ssing/SaturationDynamic/RelationalOperator
        # combined # update of variable(s) associated with ComfortableDS_COM/IndexProcessing/IndexBr
        akeFrequencyLow/IndexProcessing/Factor_na */
    if (SUssIdxPrcR2_Switch1 > SUssIdxPrcR1_Factor_na) {
        /* Switch: ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/IndexProcessing/Saturati
            onDynamic/Switch
            # combined # update of variable(s) associated with ComfortableDS_COM/IndexProcessing/Ind
            exBrakeFrequencyLow/IndexProcessing/Factor_na
            # combined # Unit delay: ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/IndexP
            rocessing/Unit Delay */
        pISV->X_SUssIdxPrcR1_Unit_Delay = SUssIdxPrcR1_Factor_na;
    }
    else {
        /* Switch: ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/IndexProcessing/Saturati
            onDynamic/Switch
            # combined # Unit delay: ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/IndexP
            rocessing/Unit Delay */
        pISV->X_SUssIdxPrcR1_Unit_Delay = SUssIdxPrcR2_Switch1;
    }

    /* TargetLink outport: ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/IndexProcessing/
        IndexOut_na
        # combined # Unit delay: ComfortableDS_COM/IndexProcessing/IndexBrakeFrequencyLow/IndexProce
        ssing/Unit Delay */
    *SUssIdxPrcR1_IndexOut_na = pISV->X_SUssIdxPrcR1_Unit_Delay;
}
