# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_GC_stub.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 10 "<built-in>"
...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_GC_stub.c" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 2 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_GC_stub.c" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 3 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_GC_stub.c" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/rte\\USSDB_MemMap.h" 1
# 4 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_GC_stub.c" 2
void USS_GC_stub(void)
{
 __ASTREE_check(( USS_SIH_s_ACADxObj01_m_measure >= 0.F && USS_SIH_s_ACADxObj01_m_measure <= 255.875F ));
 __ASTREE_check(( USS_SIH_s_ACAVxObj01_mps_measure >= -128.F && USS_SIH_s_ACAVxObj01_mps_measure <= 127.5F ));
 __ASTREE_check(( USS_SIH_s_AgStg_rad_measure >= -13.96263408660888671875F && USS_SIH_s_AgStg_rad_measure <= 14.0596485137939453125F ));
 __ASTREE_check(( USS_SIH_s_CodCpStgWhl_measure >= 0 && USS_SIH_s_CodCpStgWhl_measure <= 3 ));
 __ASTREE_check(( USS_SIH_s_CodDrvSys_measure >= 0 && USS_SIH_s_CodDrvSys_measure <= 7 ));
 __ASTREE_check(( USS_SIH_s_DBRIdcDrvBrk_measure >= 0 && USS_SIH_s_DBRIdcDrvBrk_measure <= 7 ));
 __ASTREE_check(( USS_SIH_s_EPSStgTq_Nm_measure >= -20.F && USS_SIH_s_EPSStgTq_Nm_measure <= 20.F ));
 __ASTREE_check(( USS_SIH_s_LDALine00HztlCrvtChg_1pm2_measure >= -0.0040000001899898052215576171875F && USS_SIH_s_LDALine00HztlCrvtChg_1pm2_measure <= 0.003999984823167324066162109375F ));
 __ASTREE_check(( USS_SIH_s_LDALine00HztlCrvt_1pm_measure >= -0.125F && USS_SIH_s_LDALine00HztlCrvt_1pm_measure <= 0.1249980926513671875F ));
 __ASTREE_check(( USS_SIH_s_LDALine00HztlEndX_m_measure >= 0.F && USS_SIH_s_LDALine00HztlEndX_m_measure <= 327.670013427734375F ));
 __ASTREE_check(( USS_SIH_s_LDALine01HztlCrvtChg_1pm2_measure >= -0.0040000001899898052215576171875F && USS_SIH_s_LDALine01HztlCrvtChg_1pm2_measure <= 0.003999984823167324066162109375F ));
 __ASTREE_check(( USS_SIH_s_LDALine01HztlCrvt_1pm_measure >= -0.125F && USS_SIH_s_LDALine01HztlCrvt_1pm_measure <= 0.1249980926513671875F ));
 __ASTREE_check(( USS_SIH_s_LDALine01HztlEndX_m_measure >= 0.F && USS_SIH_s_LDALine01HztlEndX_m_measure <= 327.670013427734375F ));
 __ASTREE_check(( USS_SIH_s_LDALine02HztlCrvtChg_1pm2_measure >= -0.0040000001899898052215576171875F && USS_SIH_s_LDALine02HztlCrvtChg_1pm2_measure <= 0.003999984823167324066162109375F ));
 __ASTREE_check(( USS_SIH_s_LDALine02HztlCrvt_1pm_measure >= -0.125F && USS_SIH_s_LDALine02HztlCrvt_1pm_measure <= 0.1249980926513671875F ));
 __ASTREE_check(( USS_SIH_s_LDALine02HztlEndX_m_measure >= 0.F && USS_SIH_s_LDALine02HztlEndX_m_measure <= 327.670013427734375F ));
 __ASTREE_check(( USS_SIH_s_LDALine09HztlCrvtChg_1pm2_measure >= -0.0040000001899898052215576171875F && USS_SIH_s_LDALine09HztlCrvtChg_1pm2_measure <= 0.003999984823167324066162109375F ));
 __ASTREE_check(( USS_SIH_s_LDALine09HztlCrvt_1pm_measure >= -0.125F && USS_SIH_s_LDALine09HztlCrvt_1pm_measure <= 0.1249980926513671875F ));
 __ASTREE_check(( USS_SIH_s_LDALine09HztlEndX_m_measure >= 0.F && USS_SIH_s_LDALine09HztlEndX_m_measure <= 327.670013427734375F ));
 __ASTREE_check(( USS_SIH_s_LDALine10HztlCrvtChg_1pm2_measure >= -0.0040000001899898052215576171875F && USS_SIH_s_LDALine10HztlCrvtChg_1pm2_measure <= 0.003999984823167324066162109375F ));
 __ASTREE_check(( USS_SIH_s_LDALine10HztlCrvt_1pm_measure >= -0.125F && USS_SIH_s_LDALine10HztlCrvt_1pm_measure <= 0.1249980926513671875F ));
 __ASTREE_check(( USS_SIH_s_LDALine10HztlEndX_m_measure >= 0.F && USS_SIH_s_LDALine10HztlEndX_m_measure <= 327.670013427734375F ));
 __ASTREE_check(( USS_SIH_s_ODStFct_measure >= 0 && USS_SIH_s_ODStFct_measure <= 255 ));
 __ASTREE_check(( USS_SIH_s_ODStObjClas_measure >= 0 && USS_SIH_s_ODStObjClas_measure <= 255 ));
 __ASTREE_check(( USS_SIH_s_ODValObjProb_measure >= 0 && USS_SIH_s_ODValObjProb_measure <= 255 ));
 __ASTREE_check(( USS_SIH_s_VDSOLgtA_mps2_measure >= -163.839996337890625F && USS_SIH_s_VDSOLgtA_mps2_measure <= 163.839996337890625F ));
 __ASTREE_check(( USS_SIH_s_VDSOVLgt_mps_measure >= -127.8000030517578125F && USS_SIH_s_VDSOVLgt_mps_measure <= 127.8000030517578125F ));
 __ASTREE_check(( USS_SIH_s_VLimTrfcSign_measure >= 0 && USS_SIH_s_VLimTrfcSign_measure <= 255 ));
 __ASTREE_modify(( USS_GC_s_ACAVxObj01_kmph_measure; [-460.79998779296875F ,459.F] ));
 __ASTREE_modify(( USS_GC_s_AgStg_deg_measure; [-819.F ,819.3800048828125F] ));
 __ASTREE_modify(( USS_GC_s_AnimalDet_measure; [0 ,1] ));
 __ASTREE_modify(( USS_GC_s_BrkFrq_measure; [0 ,255] ));
 __ASTREE_modify(( USS_GC_s_EPSStgTqFil_Nm_measure; [-20.F ,20.950000762939453125F] ));
 __ASTREE_modify(( USS_GC_s_FlgCpStgWhlPres_measure; [0 ,1] ));
 __ASTREE_modify(( USS_GC_s_FlgElDrvSys_measure; [0 ,1] ));
 __ASTREE_modify(( USS_GC_s_FlgHighRoadCrvt_measure; [0 ,1] ));
 __ASTREE_modify(( USS_GC_s_FlgHybDrvSys_measure; [0 ,1] ));
 __ASTREE_modify(( USS_GC_s_FlgLeadVehAvl_measure; [0 ,1] ));
 __ASTREE_modify(( USS_GC_s_LeadVehTiDist_s_measure; [0.F ,60.F] ));
 __ASTREE_modify(( USS_GC_s_MaxSignVLim_kmph_measure; [0.F ,255.F] ));
 __ASTREE_modify(( USS_GC_s_ObstDet_measure; [0 ,1] ));
 __ASTREE_modify(( USS_GC_s_StgFrq_measure; [0 ,255] ));
 __ASTREE_modify(( USS_GC_s_VDSOLgtAFil_mps2_measure; [-163.839996337890625F ,163.839996337890625F] ));
 __ASTREE_modify(( USS_GC_s_VDSOVLgt_kmph_measure; [-460.100006103515625F ,460.100006103515625F] ));
 __ASTREE_modify(( USS_GC_s_VEvalEve_measure; [0 ,1] ));
 __ASTREE_modify(( USS_GC_s_VNotSdsl_measure; [0 ,1] ));
}
