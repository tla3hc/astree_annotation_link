# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DA_POP/src/USS_DA_POP.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 10 "<built-in>"
...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DA_POP/src/USS_DA_POP.c" 2
/**************************************************************************************************\
 *** 
 *** Simulink model       : USS_DA_POP
 *** TargetLink subsystem : USS_DA_POP/FrameUSS_DA_POP/Subsystem/FrameUSS_DA_POP/DriverActivityPostP
 ***                        rocessingDA_POP
 *** Codefile             : USS_DA_POP.c
 ***
 *** Generation date: 2024-12-04 12:09:44
 ***
 ...
 ***                                            SS_DA_POP\20_IMPL\CgTools\Common_C_Tools\Platform_Tl
 ***                                            Config\cconfig.xml
 *** Root style sheet                         : C:\Program Files\dSPACE TargetLink 4.3\Matlab\Tl\XML
 ***                                            \CodeGen\Stylesheets\TL_CSourceCodeSS.xsl
 ***
 *** SUBSYS         CORRESPONDING SIMULINK SUBSYSTEM
 *** SUSS_DA_POP1   DriverActivityPostProcessingDA_POP
 *** SUSS_DA_POP2   DriverActivityPostProcessingDA_POP/LatHndOffCalc
 *** SUSS_DA_POP3   DriverActivityPostProcessingDA_POP/MultiMeasure
 *** SUSS_DA_POP4   DriverActivityPostProcessingDA_POP/MultiMeasure1
 *** SUSS_DA_POP5   DriverActivityPostProcessingDA_POP/MultiMeasure2
 *** SUSS_DA_POP6   DriverActivityPostProcessingDA_POP/SafetyLevelMapping
 *** SUSS_DA_POP7   DriverActivityPostProcessingDA_POP/StatusSelection
 *** SUSS_DA_POP8   DriverActivityPostProcessingDA_POP/LatHndOffCalc/ReqBlock
 *** SUSS_DA_POP9   DriverActivityPostProcessingDA_POP/MultiMeasure/MeasSubsys
 *** SUSS_DA_POP10  DriverActivityPostProcessingDA_POP/MultiMeasure/MeasSubsys/ToWorkspaceMeasuremen
 ***                t
 *** SUSS_DA_POP11  DriverActivityPostProcessingDA_POP/MultiMeasure1/MeasSubsys
 *** SUSS_DA_POP12  DriverActivityPostProcessingDA_POP/MultiMeasure1/MeasSubsys/ToWorkspaceMeasureme
 ***                nt
 *** SUSS_DA_POP13  DriverActivityPostProcessingDA_POP/MultiMeasure2/MeasSubsys
 *** SUSS_DA_POP14  DriverActivityPostProcessingDA_POP/MultiMeasure2/MeasSubsys/ToWorkspaceMeasureme
 ***                nt
 *** SUSS_DA_POP15  DriverActivityPostProcessingDA_POP/SafetyLevelMapping/ReqBlock1
 *** SUSS_DA_POP16  DriverActivityPostProcessingDA_POP/StatusSelection/ReqBlock1
 *** 
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 90 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DA_POP/src/USS_DA_POP.c" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DA_POP/src/USS_DA_POP.h" 1
/**************************************************************************************************\
 *** 
 *** Simulink model       : USS_DA_POP
 *** TargetLink subsystem : USS_DA_POP/FrameUSS_DA_POP/Subsystem/FrameUSS_DA_POP/DriverActivityPostP
 ***                        rocessingDA_POP
 *** Codefile             : USS_DA_POP.h
 ***
 *** Generation date: 2024-12-04 12:09:44
 ***
 *** CODE GENERATOR OPTIONS:
...
/**************************************************************************************************\
    GlobalLookup1D_USS_DA_POP: Derived TL_CG default function class.
\**************************************************************************************************/
extern uint8 USS_DA_POP_Tab1DnMS0I2T0_USS_DA_POP(uint8 Nx, const uint8 * x_table, const uint8 *
     z_table, uint8 x);

/**************************************************************************************************\
    GLOBAL_FCN_UNITY_BUILD_INLINE: global inline function(s) (exported to other modules)
\**************************************************************************************************/
extern void USS_DA_POP(void);


/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 91 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DA_POP/src/USS_DA_POP.c" 2
...
(entspricht MERGEABLE_GLOBAL) | Width: 16
\**************************************************************************************************/
uint16 USS_POP_s_LatHndOffTi_s_measure = 0; /* 
    Unit: s
    LSB: 2^0 OFF: 0 MIN/MAX: 0 .. 65535
    Description: time since last driver steering activity */
# 126 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/20_IMPL/SW_USS_DA_POP/src/USS_DA_POP.c"
/**************************************************************************************************\
    GLOBAL_A2L_MODULE_OUT: mergeable global variables (RAM)
(entspricht MERGEABLE_GLOBAL) | Width: 8
\**************************************************************************************************/
uint8 USS_POP_s_StDALatSteeringActivity_measure = 0; /* 
    Unit: -
    LSB: 2^0 OFF: 0 MIN/MAX: 0 .. 255
    Description: Safety level of the Lateral Activity */
uint8 USS_POP_s_StatusDriverLateralActivity_measure = 0; /* 
    Unit: -
    LSB: 2^0 OFF: 0 MIN/MAX: 0 .. 255
    Description: state of lateral activity */
...
/**************************************************************************************************\
 ***  FUNCTION:
 ***        USS_DA_POP_Tab1DnMS0I2T0_USS_DA_POP
 *** 
 ***  DESCRIPTION:
 ...
 ***
\**************************************************************************************************/
uint8 USS_DA_POP_Tab1DnMS0I2T0_USS_DA_POP(uint8 Nx, const uint8 * x_table, const uint8 * z_table,
  uint8 x)
{
 ...
 ***
\**************************************************************************************************/
                       void USS_DA_POP(void)
{
    /* SLLocal: Default storage class for local variables | Width: 8 */
    boolean SUSS_DA_POP7_Relational_Operator1;

    /* Relational: DriverActivityPostProcessingDA_POP/StatusSelection/Relational Operator1 */
    SUSS_DA_POP7_Relational_Operator1 = USS_SIH_s_EPSStStgTq_measure != 7;

    /* Switch: DriverActivityPostProcessingDA_POP/StatusSelection/Switch3
        DriverActivityPostProcessingDA_POP/StatusSelection/Switch3: Omitted comparison with constant
        .
        # combined # Logical: DriverActivityPostProcessingDA_POP/StatusSelection/Logical Operator1
         */
    if (USS_GC_s_FlgCpStgWhlPres_measure && SUSS_DA_POP7_Relational_Operator1) {
        /* Switch: DriverActivityPostProcessingDA_POP/StatusSelection/Switch3
            # combined # TargetLink outport: DriverActivityPostProcessingDA_POP/USS_POP_s_StatusDriv
            erLateralActivity */
        USS_POP_s_StatusDriverLateralActivity_measure = 1;
    }
    else {
        /* Switch: DriverActivityPostProcessingDA_POP/StatusSelection/Switch4
            DriverActivityPostProcessingDA_POP/StatusSelection/Switch4: Omitted comparison with cons
            tant.
            # combined # Logical: DriverActivityPostProcessingDA_POP/StatusSelection/Logical Operato
            r2
            # combined # Logical: DriverActivityPostProcessingDA_POP/StatusSelection/Logical Operato
            r5 */
        if (USS_GC_s_FlgCpStgWhlPres_measure && (!(SUSS_DA_POP7_Relational_Operator1))) {
            /* Switch: DriverActivityPostProcessingDA_POP/StatusSelection/Switch4
                # combined # Switch: DriverActivityPostProcessingDA_POP/StatusSelection/Switch3
                # combined # TargetLink outport: DriverActivityPostProcessingDA_POP/USS_POP_s_Status
                DriverLateralActivity */
            USS_POP_s_StatusDriverLateralActivity_measure = 2;
        }
        else {
            /* Switch: DriverActivityPostProcessingDA_POP/StatusSelection/Switch4
                # combined # Switch: DriverActivityPostProcessingDA_POP/StatusSelection/Switch3
                # combined # TargetLink outport: DriverActivityPostProcessingDA_POP/USS_POP_s_Status
                DriverLateralActivity */
            USS_POP_s_StatusDriverLateralActivity_measure = 0;
        }
    }

    /* TargetLink outport: DriverActivityPostProcessingDA_POP/USS_POP_s_StDALatSteeringActivity
        # combined # TableLookup: DriverActivityPostProcessingDA_POP/SafetyLevelMapping/Look-Up Tabl
        e */
    USS_POP_s_StDALatSteeringActivity_measure = USS_DA_POP_Tab1DnMS0I2T0_USS_DA_POP(8,
     &(USS_POP_px_StLatStgAcv[0]), &(USS_POP_p1_StLatStgAcv[0]), USS_SIH_s_EPSStStgTq_measure);

    /* MinMax: DriverActivityPostProcessingDA_POP/LatHndOffCalc/MinMax1 */
    if (USS_LAD_s_LatInAcvTi_s_measure < USS_HOD_s_LatHodNoCntctTi_s_measure) {
        /* # combined # TargetLink outport: DriverActivityPostProcessingDA_POP/USS_POP_s_LatHndOffTi
            _s */
        USS_POP_s_LatHndOffTi_s_measure = USS_LAD_s_LatInAcvTi_s_measure;
    }
    else {
        /* # combined # TargetLink outport: DriverActivityPostProcessingDA_POP/USS_POP_s_LatHndOffTi
            _s */
        USS_POP_s_LatHndOffTi_s_measure = USS_HOD_s_LatHodNoCntctTi_s_measure;
    }
}
