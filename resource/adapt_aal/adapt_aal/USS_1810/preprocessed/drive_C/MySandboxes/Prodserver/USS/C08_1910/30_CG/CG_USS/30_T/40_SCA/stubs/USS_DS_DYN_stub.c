# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DS_DYN_stub.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 10 "<built-in>"
...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DS_DYN_stub.c" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 2 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DS_DYN_stub.c" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 3 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DS_DYN_stub.c" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/rte\\USSDB_MemMap.h" 1
# 4 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_DS_DYN_stub.c" 2
void USS_DS_DYN_stub(void)
{
 ...
 __ASTREE_check(( USS_DSE_s_EveFactorLgtAHi_measure >= 0.F && USS_DSE_s_EveFactorLgtAHi_measure <= 1.F ));
 __ASTREE_check(( USS_IP_s_FacGearShiftDyn_measure >= 0 && USS_IP_s_FacGearShiftDyn_measure <= 100 ));
 __ASTREE_check(( USS_IP_s_FacGripStgWhl_measure >= 0 && USS_IP_s_FacGripStgWhl_measure <= 100 ));
 __ASTREE_check(( USS_IP_s_FacShiftPedDwn_measure >= 0 && USS_IP_s_FacShiftPedDwn_measure <= 100 ));
 __ASTREE_modify(( USS_DYN_s_DynLvl_p100_measure; [0 ,100] ));
 __ASTREE_modify(( USS_DYN_s_IdxDyn_measure; [-1000.F ,50000.F] ));
}
