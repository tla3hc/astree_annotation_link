# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_SOH_stub.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 10 "<built-in>"
...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_SOH_stub.c" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 2 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_SOH_stub.c" 2
...
/*------------------------------------------------------------------------------------------------*\
  END OF FILE
\*------------------------------------------------------------------------------------------------*/
# 3 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_SOH_stub.c" 2
# 1 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/rte\\USSDB_MemMap.h" 1
# 4 "C:/MySandboxes/Prodserver/USS/C08_1910/30_CG/CG_USS/30_T/40_SCA/stubs/USS_SOH_stub.c" 2
void USS_SOH_stub(uint8 * SOUT_s_USS_DALatHODInterpretation_en, uint16 *
  SOUT_s_USS_DALatHODNoContactTime_s, uint16 * SOUT_s_USS_DALatHandsOffTime_s, uint16 *
  SOUT_s_USS_DALatInactiveTime_s, uint8 * SOUT_s_USS_DALatSteeringActivity_en, uint8 *
  SOUT_s_USS_DA_CtStgDet, uint8 * SOUT_s_USS_DS_ComfortLevel, uint8 * SOUT_s_USS_DS_DriverType,
  uint8 * SOUT_s_USS_DS_DriverTypeLongterm, uint8 * SOUT_s_USS_DS_EfficiencyLevel, uint8 *
...
{
 __ASTREE_modify(( *SOUT_s_USS_DALatHODInterpretation_en; [0 ,15] ));
 __ASTREE_modify(( *SOUT_s_USS_DALatHODNoContactTime_s; [0 ,507] ));
 __ASTREE_modify(( *SOUT_s_USS_DALatHandsOffTime_s; [0 ,508] ));
 __ASTREE_modify(( *SOUT_s_USS_DALatInactiveTime_s; [0 ,508] ));
 __ASTREE_modify(( *SOUT_s_USS_DALatSteeringActivity_en; [0 ,7] ));
 __ASTREE_modify(( *SOUT_s_USS_DA_CtStgDet; [0 ,7] ));
 __ASTREE_modify(( *SOUT_s_USS_DS_ComfortLevel; [0 ,100] ));
 __ASTREE_modify(( *SOUT_s_USS_DS_DriverType; [0 ,7] ));
 __ASTREE_modify(( *SOUT_s_USS_DS_DriverTypeLongterm; [0 ,7] ));
 __ASTREE_modify(( *SOUT_s_USS_DS_EfficiencyLevel; [0 ,100] ));
 __ASTREE_modify(( *SOUT_s_USS_DS_SportinessLevel; [0 ,100] ));
 __ASTREE_modify(( *SOUT_s_USS_ImpairLevel; [0 ,7] ));
 __ASTREE_modify(( *SOUT_s_USS_ImpairLevelConf; [0 ,7] ));
 __ASTREE_modify(( *SOUT_s_USS_StDALatSteeringActivity; [0 ,7] ));
 __ASTREE_modify(( *SOUT_s_USS_StatusDriverLateralActivity; [0 ,7] ));
 __ASTREE_modify(( *SOUT_s_USS_StatusDriverType; [0 ,3] ));
 __ASTREE_modify(( *SOUT_sc_USS_DALatHODInterpretation_en; [0 ,255] ));
 __ASTREE_modify(( *SOUT_sc_USS_DALatHODNoContactTime_s; [0 ,255] ));
 __ASTREE_modify(( *SOUT_sc_USS_DALatHandsOffTime_s; [0 ,255] ));
 __ASTREE_modify(( *SOUT_sc_USS_DALatInactiveTime_s; [0 ,255] ));
 __ASTREE_modify(( *SOUT_sc_USS_DALatSteeringActivity_en; [0 ,255] ));
 __ASTREE_modify(( *SOUT_sc_USS_DA_CtStgDet; [0 ,255] ));
 __ASTREE_modify(( *SOUT_sc_USS_DS_ComfortLevel; [0 ,255] ));
 __ASTREE_modify(( *SOUT_sc_USS_DS_DriverType; [0 ,255] ));
 __ASTREE_modify(( *SOUT_sc_USS_DS_DriverTypeLongterm; [0 ,255] ));
 __ASTREE_modify(( *SOUT_sc_USS_DS_EfficiencyLevel; [0 ,255] ));
 __ASTREE_modify(( *SOUT_sc_USS_DS_SportinessLevel; [0 ,255] ));
 __ASTREE_modify(( *SOUT_sc_USS_ImpairLevel; [0 ,255] ));
 __ASTREE_modify(( *SOUT_sc_USS_ImpairLevelConf; [0 ,255] ));
 __ASTREE_modify(( *SOUT_sc_USS_StDALatSteeringActivity; [0 ,255] ));
 __ASTREE_modify(( *SOUT_sc_USS_StatusDriverLateralActivity; [0 ,255] ));
 __ASTREE_modify(( *SOUT_sc_USS_StatusDriverType; [0 ,255] ));
 __ASTREE_modify(( *USSDB_s_FlgDTCACAErr; [0 ,1] ));
 __ASTREE_modify(( *USSDB_s_FlgDTCACCErr; [0 ,1] ));
 __ASTREE_modify(( *USSDB_s_FlgDTCAPIErr; [0 ,1] ));
 __ASTREE_modify(( *USSDB_s_FlgDTCDrvAcvErr; [0 ,1] ));
 __ASTREE_modify(( *USSDB_s_FlgDTCDrvDrgErr; [0 ,1] ));
 __ASTREE_modify(( *USSDB_s_FlgDTCDrvStylErr; [0 ,1] ));
 __ASTREE_modify(( *USSDB_s_FlgDTCEPSErr; [0 ,1] ));
 __ASTREE_modify(( *USSDB_s_FlgDTCErr; [0 ,1] ));
 __ASTREE_modify(( *USSDB_s_FlgDTCEscBtnErr; [0 ,1] ));
 __ASTREE_modify(( *USSDB_s_FlgDTCEscErr; [0 ,1] ));
 __ASTREE_modify(( *USSDB_s_FlgDTCKLRErr; [0 ,1] ));
 __ASTREE_modify(( *USSDB_s_FlgDTCLDAErr; [0 ,1] ));
 __ASTREE_modify(( *USSDB_s_FlgDTCMFLErr; [0 ,1] ));
 __ASTREE_modify(( *USSDB_s_FlgDTCVDSOErr; [0 ,1] ));
 __ASTREE_modify(( *USSDB_s_FlgDTCVMMPErr; [0 ,1] ));
 __ASTREE_check(( USS_COM_s_ComLvl_p100_measure >= 0 && USS_COM_s_ComLvl_p100_measure <= 100 ));
 __ASTREE_check(( USS_DSF_s_StDrvTyp_measure >= 0 && USS_DSF_s_StDrvTyp_measure <= 7 ));
 __ASTREE_check(( USS_DSF_s_StDrvTypLngTrm_measure >= 0 && USS_DSF_s_StDrvTypLngTrm_measure <= 7 ));
 __ASTREE_check(( USS_DYN_s_DynLvl_p100_measure >= 0 && USS_DYN_s_DynLvl_p100_measure <= 100 ));
 __ASTREE_check(( USS_EFF_s_EffLvl_p100_measure >= 0 && USS_EFF_s_EffLvl_p100_measure <= 100 ));
 __ASTREE_check(( USS_HOD_s_LatHodIntrp_measure >= 0 && USS_HOD_s_LatHodIntrp_measure <= 15 ));
 __ASTREE_check(( USS_HOD_s_LatHodNoCntctTi_s_measure >= 0 && USS_HOD_s_LatHodNoCntctTi_s_measure <= 507 ));
 __ASTREE_check(( USS_IIF_s_ImpairLevel_measure >= 0 && USS_IIF_s_ImpairLevel_measure <= 7 ));
 __ASTREE_check(( USS_IIF_s_ImpairLevelConf_measure >= 0 && USS_IIF_s_ImpairLevelConf_measure <= 7 ));
 __ASTREE_check(( USS_LAD_s_CntrStgDet_measure >= 0 && USS_LAD_s_CntrStgDet_measure <= 7 ));
 __ASTREE_check(( USS_LAD_s_LatInAcvTi_s_measure >= 0 && USS_LAD_s_LatInAcvTi_s_measure <= 508 ));
 __ASTREE_check(( USS_LAD_s_LatStgAcv_measure >= 0 && USS_LAD_s_LatStgAcv_measure <= 7 ));
 __ASTREE_check(( USS_POP_s_LatHndOffTi_s_measure >= 0 && USS_POP_s_LatHndOffTi_s_measure <= 508 ));
 __ASTREE_check(( USS_POP_s_StDALatSteeringActivity_measure >= 0 && USS_POP_s_StDALatSteeringActivity_measure <= 7 ));
 __ASTREE_check(( USS_POP_s_StatusDriverLateralActivity_measure >= 0 && USS_POP_s_StatusDriverLateralActivity_measure <= 7 ));
 __ASTREE_check(( USS_SIH_s_BitFldDTC_measure >= 0 && USS_SIH_s_BitFldDTC_measure <= 65535 ));
 __ASTREE_check(( USS_SIH_s_CntrStgDet_SigSt_measure >= 0 && USS_SIH_s_CntrStgDet_SigSt_measure <= 3 ));
 __ASTREE_check(( USS_SIH_s_ComLvl_p100_SigSt_measure >= 0 && USS_SIH_s_ComLvl_p100_SigSt_measure <= 3 ));
 __ASTREE_check(( USS_SIH_s_CpStgWhlErr_measure >= 0 && USS_SIH_s_CpStgWhlErr_measure <= 1 ));
 __ASTREE_check(( USS_SIH_s_CpStgWhlTch_SigSt_measure >= 0 && USS_SIH_s_CpStgWhlTch_SigSt_measure <= 3 ));
 __ASTREE_check(( USS_SIH_s_DynLvl_p100_SigSt_measure >= 0 && USS_SIH_s_DynLvl_p100_SigSt_measure <= 3 ));
 __ASTREE_check(( USS_SIH_s_EPSStStgTq_SigSt_measure >= 0 && USS_SIH_s_EPSStStgTq_SigSt_measure <= 3 ));
 __ASTREE_check(( USS_SIH_s_EffLvl_p100_SigSt_measure >= 0 && USS_SIH_s_EffLvl_p100_SigSt_measure <= 3 ));
 __ASTREE_check(( USS_SIH_s_ImpLvl_SigSt_measure >= 0 && USS_SIH_s_ImpLvl_SigSt_measure <= 3 ));
 __ASTREE_check(( USS_SIH_s_SteeringActivity_SigSt_measure >= 0 && USS_SIH_s_SteeringActivity_SigSt_measure <= 3 ));
}
